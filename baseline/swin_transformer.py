...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=512, patch_size=4, in_chans=1, num_classes=3,
...
def Swin_S(num_classes=3, config=[2,2,18,2], dim=96, **kwargs):
    return SwinTransformer(num_classes=num_classes, config=config, dim=dim, **kwargs)
