...
class Multiscale_Stage(nn.Module):
    ...
    def forward(self, guide):
        ...
        attn = self.mhca_blks1(x, (H, W)) #(1,64,64,64)
        #conv = self.InvRes(guide) #(1,64,64,64)
        conv = self.mhca_blks2(x, (H, W))  # (1,64,64,64)
