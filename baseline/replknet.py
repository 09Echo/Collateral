...
class RepLKNet(nn.Module):
    ...
    def __init__(self, large_kernel_sizes, layers, channels, drop_path_rate, small_kernel,
                 dw_ratio=1, ffn_ratio=4, in_channels=1, num_classes=3, out_indices=None,
...
def create_RepLKNet31B(drop_path_rate=0.3, num_classes=2, use_checkpoint=False, small_kernel_merged=False):
...
def create_RepLKNet31L(drop_path_rate=0.3, num_classes=2, use_checkpoint=True, small_kernel_merged=False):
...
def create_RepLKNetXL(drop_path_rate=0.3, num_classes=3, use_checkpoint=True, small_kernel_merged=False):
